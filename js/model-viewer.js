...
AFRAME.registerComponent("model-viewer", {
  ...
  update: function () {
    ...
    console.log("MyModel", this.data.gltfModel);
  },
  ...
  initEntities: function () {
    ...
    //set light visible true or false
    var modelLight = document.createElement("a-entity");
    modelLight.id = "tempLight";
    ...
    modelLight.setAttribute("position", "0 0.025 0");
    modelLight.setAttribute("scale", "1 1 1");
    modelLight.setAttribute("visible", "false");
    modelLight.setAttribute("hide-on-enter-ar", "");

    modelPivotEl.id = "modelPivot";

    this.el.appendChild(sceneLightEl);
    this.el.appendChild(modelLight);
    ...
    titleEl.setAttribute(
      "text",
      "value: " + this.data.title + "; width: 6; color: black"
    );
  ...
  centerAndScaleModel: function () {
    ...
    shadowEl.object3D.position.z = 0;
    shadowEl.object3D.position.x = 0;
