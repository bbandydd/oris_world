...
AFRAME.registerComponent('info-message', {
  ...
  update: function () {
    ...
    messageEl.innerHTML = this.data.htmlSrc.innerHTML;
  ...
  addStyles: function () {
    var css =
      ...
      '.a-info-message-button {background-size: 92% 90%; padding: 0; border: 3px solid #aaaaaa; color: #aaaaaa; font-size: 16px; font-weight: bolder; bottom: 0; cursor: pointer; min-width: 78px; min-height: 34px; padding-right: 0; padding-top: 0; position: absolute; right: 0; transition: background-color .05s ease; -webkit-transition: background-color .05s ease; z-index: 9999; border-radius: 8px; touch-action: manipulation;}' +
